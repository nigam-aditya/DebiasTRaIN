...
class IntrasentenceLoader(object):
    ...
    def __init__(
        ...
        stereoset = StereoSet(input_file, bias_types_to_load=bias_types_to_load)
        ...
        self._return_target_tokens = return_target_tokens
...
class StereoSet(object):
    def __init__(self, location, json_obj=None, bias_types_to_load=None):
    ...
    def __create_intrasentence_examples__(self, examples):
        ...
        for example in examples:
            sentences = []
            if self._bias_types_to_load and example["bias_type"] not in self._bias_types_to_load:
                continue
